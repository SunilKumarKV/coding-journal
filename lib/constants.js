...
export const DEFAULT_SOLUTION_TEMPLATES = [
  { filename: "javascript.js", language: "JavaScript" },
  { filename: "java.java", language: "Java" },
  { filename: "c.c", language: "C" }
];

export const LANGUAGE_FILE_MAP = {
  javascript: { language: "JavaScript", filename: "javascript.js" },
  js: { language: "JavaScript", filename: "javascript.js" },
  typescript: { language: "TypeScript", filename: "typescript.ts" },
  ts: { language: "TypeScript", filename: "typescript.ts" },
  java: { language: "Java", filename: "java.java" },
  c: { language: "C", filename: "c.c" },
  "c++": { language: "C++", filename: "cpp.cpp" },
  cpp: { language: "C++", filename: "cpp.cpp" },
  python: { language: "Python", filename: "python.py" },
  py: { language: "Python", filename: "python.py" }
};
